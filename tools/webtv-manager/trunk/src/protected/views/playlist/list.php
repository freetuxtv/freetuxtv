...
<?php
		...
		if($lang[WebStream::TypeWebTV] > 0){
			$playlist_link = $this->createUrl('playlists/playlist_webtv_'.$lang['LangCode'].'.m3u');
?>
...
<?php
		...
		if($lang[WebStream::TypeWebRadio] > 0){
			$playlist_link = $this->createUrl('playlists/playlist_webradio_'.$lang['LangCode'].'.m3u');
?>
...
<?php
		...
		if($lang[WebStream::TypeWebProgram] > 0){
			$playlist_link = $this->createUrl('playlists/playlist_programmes_'.$lang['LangCode'].'.m3u');
?>
...
<?php
		...
		if($lang[WebStream::TypeWebCam] > 0){
			$playlist_link = $this->createUrl('playlists/playlist_webcam_'.$lang['LangCode'].'.m3u');
?>
