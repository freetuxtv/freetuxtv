...
('modoHideComment', 'Allow to Hide or Valid a Comment');

CREATE TABLE wtvmT_Comment
(
    id INTEGER NOT NULL AUTO_INCREMENT,  
    WebStreamId INTEGER NULL,
    HistoryId INTEGER NULL,
    Content VARCHAR(255) NOT NULL,
	Statut INTEGER(10) NOT NULL,
 	CONSTRAINT PK_Comment PRIMARY KEY(Id),
    CONSTRAINT FK_Comment_WebStream FOREIGN KEY (WebStreamId)
        REFERENCES wtvmT_WebStream(Id),
